...
UBE3A$Number1 <- -4
plot(UBE3A$Frequency~UBE3A.2, ylab = "", xlab = "", xlim=c(1,ProteinSize), ylim=c(-4, max(3)), xaxs="i",yaxs="i", yaxt="none", xaxt="none", type = 'h', col = "dodgerblue1", bty="n")
...
par(new=TRUE)
plot(UBE3A_ClinVar$Number~UBE3A_ClinVar.2,ylab = "", xlab = "", xlim=c(1,ProteinSize), ylim=c(-3.1, max(8)), xaxs="i",yaxs="i", yaxt="none", xaxt="none", type="h", col = "red2", bty="n")
```
